...
export const ALL_OUTFITS = [
  ...
  // ── 她的衣服（女装）──
  { id: 'her_sundress', name: '碎花裙',      category: 'daily',   desc: '清新的碎花吊带裙',                price: 100, unlockAt: 0, owner: 'her' },
  { id: 'her_sweater',  name: '奶茶色毛衣',   category: 'daily',   desc: '软糯的oversize毛衣，袖子太长',    price: 120, unlockAt: 0, owner: 'her' },
  { id: 'her_shirt',    name: '白衬衫(偷他的)', category: 'home', desc: '偷了他的白衬衫穿，大了好几号',    price: 0,   unlockAt: 30, owner: 'her' },
  { id: 'her_qipao',    name: '旗袍',         category: 'formal',  desc: '复古深红旗袍，侧开叉',            price: 380, unlockAt: 45, owner: 'her' },
  { id: 'her_silk',     name: '丝质睡裙',     category: 'intimate', desc: '黑色吊带丝质睡裙，很短',         price: 250, unlockAt: 55, owner: 'her' },
  { id: 'her_lace',     name: '蕾丝内衣套装', category: 'intimate', desc: '酒红色蕾丝，若隐若现',           price: 300, unlockAt: 65, owner: 'her' },
...
export const ALL_BEDSIDE_ITEMS = [
  // ── 浪漫氛围 ──
  { id: 'candles_rose',  name: '玫瑰蜡烛',   category: 'ambiance', desc: '带玫瑰香气的蜡烛',                price: 60,  effect: 'romantic+10', consumable: true },
  { id: 'perfume',       name: '香水',        category: 'ambiance', desc: '他的古龙水，木质调',              price: 120, effect: 'romantic+15', consumable: false },
  { id: 'music_box',     name: '八音盒',      category: 'ambiance', desc: '旋律轻柔的老式八音盒',           price: 180, effect: 'romantic+20', consumable: false },
  { id: 'flowers',       name: '鲜花',        category: 'ambiance', desc: '一束新鲜的白百合',               price: 40,  effect: 'romantic+8',  consumable: true },

  // ── 情趣道具（已加浪漫值）──
  { id: 'blindfold',     name: '眼罩',        category: 'intimate', desc: '丝质眼罩',                     price: 80,  unlockAt: 50,  effect: 'romantic+5',  hint: '她拿出了眼罩——视觉被遮挡，其他感官会更加敏锐' },
  { id: 'ribbon',        name: '缎带',        category: 'intimate', desc: '一条柔软的红色缎带',             price: 80,  unlockAt: 55,  effect: 'romantic+8',  hint: '她手里拿着一条缎带，看着他的手腕' },
  { id: 'ice_cube',      name: '冰块',        category: 'intimate', desc: '冰凉的小方块',                  price: 0,   unlockAt: 45,  effect: 'romantic+3',  hint: '她把冰块含在嘴里，然后……' },
  { id: 'feather',       name: '羽毛',        category: 'intimate', desc: '柔软的鹅毛',                    price: 50,  unlockAt: 40,  effect: 'romantic+10', hint: '她拿起一根羽毛，沿着他的轮廓慢慢划过' },
  { id: 'handcuffs_silk', name: '丝巾手铐',   category: 'intimate', desc: '用丝巾做的柔软束缚',             price: 120, unlockAt: 65,  effect: 'romantic+15', hint: '她把他的手腕用丝巾系在床头，他没有反抗' },
  { id: 'dice',          name: '情趣骰子',    category: 'intimate', desc: '一面写着部位，一面写着动作',       price: 60,  unlockAt: 35,  effect: 'romantic+6',  hint: '她掷出了骰子——' },

  // ── 生活用品（不加浪漫值）──
  { id: 'pads',          name: '卫生巾',      desc: '日用超薄组合', price: 15, category: 'life', consumable: true, effect: 'health+', unlockAt: 0 },
  { id: 'condom',        name: '安全措施',    desc: '超薄舒适',     price: 12, category: 'intimate', consumable: true, effect: 'safety', unlockAt: 0 },

  // ── Lovense 预留 ──
  { id: 'lovense',       name: '智能玩具',    category: 'lovense',  desc: 'Lovense联动设备',               price: 0,   unlockAt: 999, effect: 'romantic+0', hint: '设备已连接', isPremium: true },
]
