...
export default function Lobby() {
  ...
  async function handleEnter() {
    // 把选中角色的 theme 存到 localStorage，game.js 读取
  ...
  const activeTheme = activeChar?.theme
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ textAlign: 'center', padding: '44px 20px 16px', flexShrink: 0 }}>
          ...
          <div style={{ fontSize: '10px', color: 'rgba(120,180,255,0.25)', letterSpacing: '0.2em', marginTop: '10px' }}>
            选择你的故事
          </div>
        </div>
            ...
            {CHARACTERS.map((char, idx) => {
              ...
              const cardStyle = {
                ...
                ...(isCustom ? {
                  ...
                  background: theme?.cardBg || 'linear-gradient(160deg, #080c18 0%, #040608 100%)',
                  border: isActive
                  ...
                  {isCustom ? (
                    ...
                    <div style={{
                      ...
                      <div className={isActive ? 'custom-plus-breathe' : ''} style={{
                        ...
                        fontSize: '24px',
                        color: isActive ? 'rgba(160,210,255,0.7)' : 'rgba(140,200,255,0.2)',
                        boxShadow: isActive ? '0 0 20px rgba(100,180,255,0.2)' : 'none',
                        transition: 'all 0.4s',
                      }}>+</div>
                      <div style={{
                        fontSize: isActive ? '13px' : '11px',
                        color: isActive ? 'rgba(180,220,255,0.65)' : 'rgba(140,200,255,0.22)',
                        letterSpacing: '0.1em', textAlign: 'center', lineHeight: 1.9,
                        transition: 'all 0.4s',
                      }}>
                        成与他重逢<br />
                        <span style={{ fontSize: '10px', opacity: 0.7 }}>导入你们的故事</span>
                      </div>
                    </div>
                  ) : isPlaceholder ? (
                    // 敬请期待卡 — 更明显
                    <div style={{
                      ...
                      <div style={{
                        ...
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: '22px', opacity: isActive ? 0.6 : 0.25,
                        transition: 'all 0.4s',
                      }}>✦</div>
                      <div style={{
                        fontSize: isActive ? '12px' : '10px',
                        color: isActive ? 'rgba(160,200,255,0.55)' : 'rgba(120,160,255,0.2)',
                    ...
                    <>
                      ...
                      <div style={{
                        ...
                        background: theme?.cardBg || 'linear-gradient(160deg, #0e1830 0%, #060c1e 100%)',
                      }}>
                        {char.cardImg && (
                          <img
                            src={char.cardImg}
                        ...
                        <div style={{
                          ...
                          background: 'linear-gradient(to top, rgba(6,10,28,0.98) 0%, rgba(6,10,28,0.7) 50%, transparent 100%)',
                          zIndex: 2,
                        }} />
                        {/* 顶部轻微遮罩 */}
                        <div style={{
                          position: 'absolute', top: 0, left: 0, right: 0, height: '25%',
                          background: 'linear-gradient(to bottom, rgba(6,10,28,0.3), transparent)',
                          zIndex: 2,
                        }} />
                      </div>
      ...
      {showModal && selectedChar && (
        <div
          ...
          style={{
            ...
            background: 'rgba(2,1,12,0.82)', backdropFilter: 'blur(14px)',
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '13px', color: 'rgba(180,210,240,0.45)', lineHeight: 2, letterSpacing: '0.04em', marginBottom: '18px' }}>
              {selectedChar.desc}
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button onClick={handleEnter} style={{
                ...
                boxShadow: selectedChar.theme?.btnShadow || '0 0 20px rgba(60,140,255,0.25)',
      ...
      <style>{`
        * { -webkit-tap-highlight-color: transparent; }
        ...
        @keyframes titleBreathe {
          ...
          50% {
            text-shadow:
              ...
              0 0 100px rgba(60,140,255,0.25),
              0 0 140px rgba(40,100,255,0.1);
          }
        }
        .title-breathe {
        ...
        @keyframes plusBreathe {
          0%, 100% { box-shadow: 0 0 12px rgba(100,180,255,0.12); }
          50% { box-shadow: 0 0 24px rgba(100,180,255,0.3); }
        }
        .custom-plus-breathe {
          animation: plusBreathe 2.8s ease-in-out infinite;
        }
